...
SECRET_KEY = 'django-insecure-0kb^d$ys4ikhrijz^6jhajm$yua-&jmpd8_vi$nmbdfc%014w3'

# SECURITY WARNING: don't run with debug turned on in production!/ should be switched off in production
